...
public class Test {
    ...
    public static void CyclicBarrierTest3(){
        int N = 4;
        CyclicBarrier barrier  = new CyclicBarrier(N);

        for(int i=0;i<N;i++) {
            if(i<N-1)
                new Writer3(barrier).start();
            else {
                try {
                    Thread.sleep(5000);
                } catch (InterruptedException e) {
    ...
    public static void CyclicBarrierTest4(){
        int N = 4;
        CyclicBarrier barrier  = new CyclicBarrier(N);
    ...
    static class Writer4 extends Thread{
        private CyclicBarrier cyclicBarrier;
